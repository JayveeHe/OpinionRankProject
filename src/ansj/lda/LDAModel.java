...
import ansj.lda.pojo.Doc;
import ansj.lda.pojo.Topic;
import ansj.lda.pojo.Vector;
...
public abstract class LDAModel {
     ...
     * @param saveStep       每多少步保存一次
     * @param beginSaveIters 开始的保存的迭代次数
     */
     ...
     */
    public void trainAndSave(String modelPath, String charset, int topNum) throws IOException {
        ...
        for (int i = 0; i < iteration; i++) {
            if ((i >= beginSaveIters) && (((i - beginSaveIters) % saveStep) == 0)) {
                saveModel(i + "", topNum, modelPath, charset);
            }
        ...
        saveModel("result", topNum, modelPath, charset);
     ...
     * @throws java.io.IOException
     */
    private void saveModel(String iters, int topNum, String modelPath, String charset) throws IOException {
        ...
        saveModel(iters, topNum, phi, theta, modelPath, charset);
    }

    private static final String LINES = "\n";
    private static final char[] LINEC = "\n".toCharArray();

    private void saveModel(String iters, int topNum, double[][] phi, double[][] theta, String modelPath, String charsetName) throws IOException {
        // TODO Auto-generated method stub
