...
public class LDA {
    ...
    public void trainAndSave(String modelPath, int topNum, String charset) throws IOException {
        ldaAModel.trainAndSave(modelPath, charset, topNum);
    }
