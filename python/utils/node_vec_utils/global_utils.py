...
class SentenceNodeManager(object):
    ...
    def get_global_values(self, tfidf_func=None):
        ...
        for sent in self.node_list:
            ...
            adv_rate_list.append(vec_value.get('adv_rate', 0))
        ...
        adv_rate_list = np.array(adv_rate_list)
        ...
        std_adv_rate = adv_rate_list.std() if len(adv_rate_list) > 0 else 0.0
        ...
        mean_adv_rate = adv_rate_list.mean() if len(adv_rate_list) > 0 else 0.0
        ...
        return {
            ...
            'mean_noun_rate': mean_noun_rate, 'mean_sent_len': mean_sent_len, 'mean_adv_rate': mean_adv_rate,
            'std_verb_rate': std_verb_rate, 'std_adj_rate': std_adj_rate,
            'std_noun_rate': std_noun_rate, 'std_sent_len': std_sent_len, 'std_adv_rate': std_adv_rate,
